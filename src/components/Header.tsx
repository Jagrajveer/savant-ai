      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex items-center justify-between transition-all duration-300 ease-in-out ${
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <div className={`bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center transition-all duration-300 ease-in-out ${
              isScrolled ? 'w-6 h-6' : 'w-8 h-8'
            }`}>
              <span className={`text-white font-bold transition-all duration-300 ease-in-out ${
                isScrolled ? 'text-xs' : 'text-sm'
              }`}>S</span>
            </div>
            <span className={`font-bold text-white transition-all duration-300 ease-in-out ${
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#how-it-works" className={`text-gray-300 hover:text-white transition-all duration-300 ${
              isScrolled ? 'text-sm' : 'text-base'
            }`}>How It Works</a>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link 
              to="/demo-call"
              className={`bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 hover:scale-105 ${
                isScrolled ? 'text-sm px-3 py-1.5' : 'text-base px-4 py-2'
              }`}
            >
              Book Strategy Call
