...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-1/2 -translate-x-1/2 z-50 glass border-b border-gray-700 transition-all duration-300 ease-in-out ${
      isScrolled 
        ? 'w-4/5 rounded-[10px] backdrop-blur-md bg-gray-900/95' 
        : 'w-full rounded-none backdrop-blur-sm bg-gray-900/80'
    }`}>
      <div className="px-4 sm:px-6 lg:px-8 transition-all duration-300 ease-in-out">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">SavantAI</span>
          </Link>
