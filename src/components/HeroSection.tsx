  ...
  return (
    <section className="pt-32 pb-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute -bottom-40 -left-40 w-60 h-60 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 rounded-full animate-pulse delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-600/5 to-purple-600/5 rounded-full animate-float"></div>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Trust Badge */}
        <div className="inline-flex items-center space-x-2 glass text-blue-300 px-4 py-2 rounded-full mb-8 animate-fade-in-up hover:scale-105 transition-all duration-300">
        ...
        {/* Social Proof Badge */}
        <div className="inline-flex items-center space-x-2 glass text-gray-300 px-4 py-2 rounded-full mb-12 animate-fade-in-up delay-500 hover:scale-105 transition-all duration-300">
        ...
        {/* What You'll Get */}
        <div className="glass rounded-2xl p-8 mb-12 max-w-2xl mx-auto animate-fade-in-up delay-600 hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-gray-700">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-center space-x-3 group hover:translate-x-2 transition-all duration-300">
              <div className="w-6 h-6 bg-emerald-500/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-emerald-500/30">
