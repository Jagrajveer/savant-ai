  ...
  return (
    <section className="pt-32 pb-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 left-20 w-4 h-4 bg-slate-400/30 rounded-full animate-neural-network delay-0"></div>
        <div className="absolute top-40 right-32 w-3 h-3 bg-indigo-400/30 rounded-full animate-neural-network delay-500"></div>
        <div className="absolute bottom-32 left-16 w-5 h-5 bg-gray-400/30 rounded-full animate-neural-network delay-1000"></div>
        <div className="absolute bottom-20 right-20 w-4 h-4 bg-stone-400/30 rounded-full animate-neural-network delay-1500"></div>
        ...
        <div className="absolute top-1/3 left-1/4 w-32 h-32 border border-slate-400/20 rounded-lg animate-circuit-pulse delay-0 rotate-45"></div>
        <div className="absolute bottom-1/3 right-1/4 w-24 h-24 border border-indigo-400/20 rounded-lg animate-circuit-pulse delay-1000 rotate-12"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Trust Badge */}
        <div className="inline-flex items-center space-x-2 glass text-slate-300 px-4 py-2 rounded-full mb-8 animate-bounce-fade-in hover:scale-105 transition-all duration-300 card-hover-bounce">
          <Zap size={16} className="animate-pulse text-indigo-400" />
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in-up delay-200">
          Scale Smarter with{' '}
          <span className="bg-gradient-to-r from-slate-400 to-indigo-400 bg-clip-text text-transparent animate-gradient-shift">
        ...
        <div className="glass rounded-2xl p-8 mb-12 max-w-2xl mx-auto animate-bounce-fade-in delay-600 hover:shadow-2xl transition-all duration-500 card-hover-bounce border border-gray-700">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-center space-x-3 group hover:translate-x-2 transition-all duration-300">
              <div className="w-6 h-6 bg-stone-500/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-stone-500/30 animate-circuit-pulse">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-fade-in-up delay-800">
          <Link
            to="/demo-call"
            className="bg-gradient-to-r from-slate-600 to-indigo-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-slate-700 hover:to-indigo-700 transition-all duration-300 flex items-center space-x-2 hover:scale-105 hover:shadow-lg transform active:scale-95 group animate-glow"
          >
